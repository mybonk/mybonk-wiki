...
### 1.3. Install the Nix packages
  Before you start:
  - Make sure your Linus system is updated (especially if you are running it from a VM)
  `sudo atp update`
  - Make sure your have `curl` installed or install it with `sudo atp install curl`
